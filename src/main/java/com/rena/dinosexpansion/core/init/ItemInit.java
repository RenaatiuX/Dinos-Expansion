...
public class ItemInit {
    ...
    public static final RegistryObject<CustomArrowItem> DART_ARROW = ITEMS.register("dart_arrow", () -> new CustomArrowItem(new Item.Properties().group(ModItemGroups.WEAPONS), (world, arrow, shooter) -> new CustomArrow(shooter, world, arrow,1d, 10)));
    ...
    public static final RegistryObject<CustomArrowItem> STEEL_ARROW = ITEMS.register("steel_arrow", () -> new CustomArrowItem(new Item.Properties().group(ModItemGroups.WEAPONS), (world, arrow, shooter) -> new CustomArrow(shooter, world, arrow,4.5)));
