...
public class BlockEntityInit {
    ...
    public static final RegistryObject<TileEntityType<UnknownLockTileEntity>> UNKNOWN_TE = TES.register("unknown_lock_te", () -> TileEntityType.Builder.create(UnknownLockTileEntity::new, BlockInit.FUTURISTIC_LOCK_BLOCK.get(), BlockInit.FUTURISTIC_LOCK_FRAME_BLOCK.get()).build(null));
}
