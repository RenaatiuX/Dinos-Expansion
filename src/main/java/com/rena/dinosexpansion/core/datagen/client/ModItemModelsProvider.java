...
public class ModItemModelsProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        spawnEgg(ItemInit.PARAPUZOSIA_SPAWN_EGG.get(), ItemInit.EOSQUALODON_SPAWN_EGG.get(), ItemInit.MEGA_PIRANHA_SPAWN_EGG.get(), ItemInit.DIMORPHODON_SPAWN_EGG.get(), ItemInit.ASTORGOSUCHUS_SPAWN_EGG.get(), ItemInit.CAMPANILE_SPAEN_EGG.get());
