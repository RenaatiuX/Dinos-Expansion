...
import com.rena.dinosexpansion.client.model.entity.WheterellusModel;
...
public class WheterellusRenderer extends GeoEntityRenderer<Wheterellus> {
    ...
    @Override
    public RenderType getRenderType(Wheterellus animatable, float partialTicks, MatrixStack stack, @Nullable IRenderTypeBuffer renderTypeBuffer, @Nullable IVertexBuilder vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
