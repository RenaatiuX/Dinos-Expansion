...
public class JournalScreen extends Screen {
    ...
    private static final ResourceLocation TEXTURE = DinosExpansion.modLoc("textures/gui/explorer_journal/explorer_journal.png");
    private static final ResourceLocation DRAWINGS_0 = DinosExpansion.modLoc("textures/gui/explorer_journal/drawings_0.png");
    private static final Map<String, ResourceLocation> PICTURE_LOCATION_CACHE = Maps.newHashMap();
    public List<JournalPages> allPageTypes = new ArrayList<>();
    public JournalPages pageType;
    ...
    public JournalScreen(ItemStack journal) {
        ...
        if (!journal.isEmpty() && journal.getItem() != null && journal.getItem() == ItemInit.EXPLORER_JOURNAL.get()) {
            if (journal.getTag() != null) {
                List<JournalPages> pages = JournalPages.containedPages(JournalPages.toList(journal.getTag().getIntArray("Pages")));
    ...
    public void imageFromTxt(MatrixStack ms) {
        ...
        ResourceLocation backupLoc = DinosExpansion.modLoc("lang/explorer_journal/en_us_0/" + fileName);
            ...
            while (iterator.hasNext()) {
                ...
                if (line.contains("<") || line.contains(">")) {
                    if (line.contains("<image>")) {
                        ...
                        String texture = String.valueOf(DinosExpansion.modLoc("textures/gui/explorer_journal/" + split[0]));
    ...
    public void writeFromTxt(MatrixStack ms) {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                if (linenumber <= 19) {
                    font.drawString(ms, line, 23, 20 + linenumber * 10, 0X303030);
                } else {
