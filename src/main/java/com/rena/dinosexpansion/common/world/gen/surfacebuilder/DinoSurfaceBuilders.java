...
public class DinoSurfaceBuilders {
    ...
    public static final Supplier<SurfaceBuilderConfig> DENSE_SWAMP_SB = () -> new SurfaceBuilderConfig(Blocks.GRASS_BLOCK.getDefaultState(), Blocks.DIRT.getDefaultState(), BlockInit.MUD.get().getDefaultState());
    ...
    public static final Supplier<SurfaceBuilderConfig> LAKE_SB = () -> new SurfaceBuilderConfig(Blocks.GRASS_BLOCK.getDefaultState(), Blocks.DIRT.getDefaultState(), Blocks.GRAVEL.getDefaultState());
    ...
    public static final Supplier<ConfiguredSurfaceBuilder<SurfaceBuilderConfig>> ETHEREAL_SWAMP = () -> SurfaceBuilderInit.MARSHLAND.get().func_242929_a(DENSE_SWAMP_SB.get());
    ...
    public static final Supplier<ConfiguredSurfaceBuilder<SurfaceBuilderConfig>> LAKE = () -> SurfaceBuilderInit.LAKE.get().func_242929_a(LAKE_SB.get());
}
