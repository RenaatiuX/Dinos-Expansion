...
public class GeneratedOre {
    ...
    public static void generateOres(final BiomeLoadingEvent event){
        if (event.getName() != null){
            for (GeneratingOres ore : GeneratingOres.values()){
                if (ore.shouldGenerate(event.getName())){
                    OreFeatureConfig config = new OreFeatureConfig(ore.fills(), ore.getBlock().getDefaultState(), ore.getMaxVeinSize());
                    ...
                    ConfiguredFeature<?, ?> oreFeature = registerOreFeature(ore, config, configuredPlacement);
    ...
    private static ConfiguredFeature<?, ?> registerOreFeature(GeneratingOres ore, OreFeatureConfig oreFeatureConfig,
