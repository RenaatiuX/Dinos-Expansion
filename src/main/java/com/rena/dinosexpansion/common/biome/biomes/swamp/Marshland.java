...
public class Marshland extends BiomeBase {
    ...
    static final BiomeGenerationSettings.Builder GENERATION_SETTINGS = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(DinoSurfaceBuilders.MARSHLAND::get);
