...
public class AxeSpearItem extends TieredSpear {
    ...
    public AxeSpearItem(Properties properties, SpearTier spearTier) {
        super(properties, spearTier);
        this.effectiveBlocks = EFFECTIVE_ON_BLOCKS;
        ...
        if (blockStrip != null) {
            ...
            if (!world.isRemote) {
                ...
                if (playerentity != null) {
                    context.getItem().damageItem(1, playerentity, (p_lambda$onItemUse$0_1_) -> {
                        p_lambda$onItemUse$0_1_.sendBreakAnimation(context.getHand());
                    });
                }
            }
