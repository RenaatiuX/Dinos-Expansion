...
public class DinosaurJumLikeDolphin extends JumpGoal {

    private static final int[] JUMP_DISTANCES = new int[]{0, 1, 4, 5, 6, 7};
    private final DinosaurAquatic dolphin;
    private final int chance;
    private boolean inWater;

    public DinosaurJumLikeDolphin(DinosaurAquatic dolphin, int chance) {
