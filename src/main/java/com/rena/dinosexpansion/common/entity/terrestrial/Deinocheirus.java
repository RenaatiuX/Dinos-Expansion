...
public class Deinocheirus extends ChestedDinosaur implements IAnimatable, IAnimationTickable {
    public Deinocheirus(EntityType<? extends TameableEntity> type, World world, DinosaurInfo info, int level) {
