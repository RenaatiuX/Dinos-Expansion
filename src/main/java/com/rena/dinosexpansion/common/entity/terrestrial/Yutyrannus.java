...
public class Yutyrannus extends ChestedDinosaur implements IAnimatable, IAnimationTickable {
    public Yutyrannus(EntityType<? extends TameableEntity> type, World world, DinosaurInfo info, int level) {
